...
// const DEFAULT_ACCOUNT_ID: &str = "hassel.near";
// const DEFAULT_MINER_ACCOUNT_ID: &str = "hassel.near";

// // set_environment_with_context!(DEFAULT_ACCOUNT_ID, 100000000, NearToken::from_yoctonear(10u128.pow(24)));

// fn set_environment_with(account_id: AccountId) {
...
// fn default_miner_account() -> AccountId {
//     // get_default_miner_account
//     DEFAULT_MINER_ACCOUNT_ID.parse().unwrap()
// }

// fn assert_logs() {
//     // longitud, evento, data...
//     let logs = get_logs();
...
// fn assert_log(event: &str, data: Vec<(&str, &str)>) {
//     let logs = get_logs();
//     assert_eq!(logs.len(), 1);
//     let mut log = r#"EVENT_JSON:{"standard":"emip001","version":"1.0.0","event":""#.to_string();
//     log.push_str(event);
//     log.push_str(r#"","data":["#);
...
//     set_environment_with(default_miner_account());
...
//     assert_log("register_miner", vec![("miner", "hassel.near")]);
// }
...
//     assert_logs(1, "register_miner", vec![("miner", "hassel.near")]);

//     // register miner 2
//     set_environment_with(second_miner());
...
//     assert_logs(1, "register_miner", vec![("miner", "edson.near")]);
// }
...
//     register_default_miner(); //  contract.register_miner();

//     register_default_validator();

//     execute_default_request();

//     commit_by_default_miner();

//     // validator commit
//     //  contract.register_validator();
//     // const DEFAULT_MINER = 'miner1.near';
//     // const DEFAULT_MINER_ACCOUNT_ID = DEFAULT_MINER.parse().unwrap();
