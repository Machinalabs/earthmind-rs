...
impl Contract {
    ...
    // De las funciones de registro de los usuario se movieron, pero en el caso de las funciones get si serian necesarias para saber que usuario en especifico buscamos
    pub fn get_register_validator(&self, validator_id: AccountId) -> Option<&AccountId> {
        // se usa iter porque al usar el tipo Vector que es de la biblioteca NearSDk, no tiene el método contains() o se debe pensar en una nueva estructura de datos 
    ...
    // TODO: Then, I receive the string and a hash it, and that hash is the request_id (possibly to also concatenate the sender account_id and hash it)
    // Si concatemos el valor del sender accountse podria preguntar lo mismo con diferente cuenta ya que el hash cambiaria, por eso solo se considera la pregunta como hash 
    pub fn request_governance_decision(&mut self, message: String) -> RegisterRequestResult {

        // TODO: The request_id should be generated by the contract
        // TODO: Define what a request is... is a string message with like a question...i.e "Puedo agregar this NFT to the collection"
    ...
    pub fn commit_by_miner(&mut self, request_id: String, answer: bool, message: String) {
    // TODO: use the environment variable to get the account_id
        ...
        //si ya tenemos la request, debemos verificar que el miner no tenga ya una propuesta registrada
    ...
    // TODO: Change string to be a vector and the vector is the top 10 miners, plus a message with the reason
    // TODO: El hash puede ser request id + validator address + miner addresseses + reason
...
#[cfg(test)]
mod tests {
    // TODO: Learn the context thing...
    // TODO: Replace all account parameters from register functions to env::predecessor_account_id()
    ...
    fn test_commit_by_miner_when_miner_and_request_exist() {
        ...
        contract.commit_by_miner(request_id, answer, message);
    ...
    #[test]
    fn test_commit_by_miner_when_miner_dont_exist_and_request_exist (){

    }
 

    #[test]
    fn test_commit_by_miner_when_miner_and_request_dont_exist (){

    }

    fn test_commit_by_miner_when_miner_exist_and_request_dont_exist () {
